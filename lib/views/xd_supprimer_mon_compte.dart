...
class XDSupprimerMonCompte extends StatelessWidget {
  XDSupprimerMonCompte({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(27.0, 60.6, 25.5, -579.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                            ...
                            Center(
                              child: SizedBox(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Align(
                                      alignment: Alignment(-0.03, -0.189),
                                      child: SizedBox(
                                        width: 5.0,
                                        height: 6.0,
                                        child:
                                    ...
                                    Align(
                                      alignment: Alignment(-0.028, 0.454),
                                      child: SizedBox(
                                        width: 1.0,
                                        height: 1.0,
                                        child:
                                          ...
                                          Container(
                                            decoration: BoxDecoration(
                                              gradient: LinearGradient(
                                                ...
                                                colors: [
                                                  const Color(0xfffee411),
                                                  const Color(0xfffedb16),
                                                  const Color(0xfffec125),
                                                  const Color(0xfffe983d),
                                                  const Color(0xfffe5f5e),
                                                  const Color(0xfffe2181),
                                                  const Color(0xff9000dc)
                                                ],
                                                stops: [
                                                  0.0,
                                                  0.052,
                            ...
                            Pinned.fromPins(
                              ...
                              child:
                                ...
                                children: <Widget>[
                                  ...
                                  Align(
                                    alignment: Alignment(0.607, -0.607),
                                    child: Container(
                                      width: 2.0,
                                      height: 2.0,
                                      decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 43.0, start: 42.0),
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(width: 3.0, color: const Color(0xfff0f01f)),
              ),
            ),
          ),
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(0.007, 0.544),
                  child: SizedBox(
                    width: 139.0,
                    height: 54.0,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          alignment: Alignment(-0.018, 0.062),
                          child: SizedBox(
                            width: 28.0,
                            height: 23.0,
                            child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 34.0, middle: 0.498),
                  Pin(size: 23.0, end: 16.5),
                  child: Text(
                    'Non',
                    style: TextStyle(
                      fontFamily: 'Avenir Next',
