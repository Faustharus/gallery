...
class XDMonProfilInfosPersonnelles extends StatelessWidget {
  XDMonProfilInfosPersonnelles({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.012, 0.025),
            child: SizedBox(
              width: 211.0,
              height: 20.0,
              child: Text(
