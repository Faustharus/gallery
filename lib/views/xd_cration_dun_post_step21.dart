...
class XDCrationDunPostStep21 extends StatelessWidget {
  XDCrationDunPostStep21({
    Key? key,
  }) : super(key: key);
  @override
                    ...
                    Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          ...
                          Pin(size: 180.0, start: 12.1),
                          child: Text(
                            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ut nibh a sapien aliquet gravida. Sed condimentum quam massa, vel tempus diam pellentesque nec. Curabitur eget accumsan neque, at tincidunt urna. Ut et nunc a neque facilisis fringilla in eu ligula. Aenean auctor scelerisque ipsum in cursus.',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                              fontSize: 13,
                              color: const Color(0xff02132b),
