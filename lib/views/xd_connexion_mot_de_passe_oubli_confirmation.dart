...
class XDConnexionMotDePasseOubliConfirmation extends StatelessWidget {
  XDConnexionMotDePasseOubliConfirmation({
    Key? key,
  }) : super(key: key);
  @override
                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          Padding(
                            padding:
                                const EdgeInsets.fromLTRB(0.0, 23.0, 0.0, 0.0),
                            child: Stack(
                              children: <Widget>[
                                Stack(
                                  children: <Widget>[
